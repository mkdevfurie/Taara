...
class _ResultScreenState extends State<ResultScreen> {
  ...
  Widget build(BuildContext context) {
    // Récupère le modèle passé en argument, ou utilise le mock
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            onPressed: () => showTaaraSnackbar(context, 'Partage à venir...'),
    ...
    return TaaraCard(
      ...
      child: Column(
        ...
        children: [
          const Row(
            children: [
              Icon(Icons.analytics_outlined, color: AppTheme.primary, size: 18),
              SizedBox(width: 8),
              Text('Diagnostic IA',
                  style: TextStyle(
